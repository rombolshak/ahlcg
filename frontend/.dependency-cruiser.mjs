export default {
  forbidden: [
    ...
    },
    {
      ...
      // This is the rule that makes #541's named cycles visible. All three named cycles — core/
      // against ui/components/{dialog,confirm-dialog} (closed by #544) and core/ against
      // features/auth (closed by #546) — are closed; the remaining violations belong to #547/#548.
      // None of them are module-level cycles, so `no-circular` above reports nothing for them and
      // only folder scope catches them.
      //
