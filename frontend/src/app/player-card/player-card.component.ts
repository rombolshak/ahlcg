...
@Component({
  ...
  template: `
    ...
    <div class="absolute top-80 w-full leading-4 px-4 font-arno" style="font-size: 1.15vw;">
      <p class="text-center mb-1 italic font-arno-bold"><span>Item. </span><span>Tome. </span><span>Science. </span></p>
