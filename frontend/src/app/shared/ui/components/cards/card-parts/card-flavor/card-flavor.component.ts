...
@Component({
  ...
  template: `<p
    class="
      ...
      group-data-[size=l]:bottom-12 group-data-[size=l]:px-12 group-data-[size=l]:text-[14px]/[14px]
      group-data-[size=m]:bottom-8 group-data-[size=m]:px-8 group-data-[size=m]:text-[10px]/[10px]
