...
- **The backend implements authentication only.** The frontend game view renders a hardcoded fixture (`@domain/test/test-game-state`) — there is no game API, no SignalR client, no deployment pipeline. Do not write code that assumes otherwise.
